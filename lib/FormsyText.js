...
var FormsyText = _react2.default.createClass({
  ...
  render: function render() {
    var _props = this.props,
        ...
        rest = _objectWithoutProperties(_props, ['defaultValue', 'requiredError', 'underlineFocusStyle', 'underlineStyle', 'updateImmediately', 'validations', 'validationError', 'validationErrors', 'value', 'validationColor']);
